...
class HashIndiretoLista {
    ...
    boolean pesquisar(String elemento, Log log) {
       int pos = h(elemento);
       return tabela[pos].pesquisar(elemento, log);
    }
 
    public void inserirInicio(Serie elemento, Log log) {
       int pos = h(elemento.getNome());
       tabela[pos].inserirInicio(elemento, log);
    }
...
class Lista {
	...
	public void inserirInicio(Serie elemento, Log log) {
        ...
        log.comp++;
		if (primeiro.elemento != null && ultimo.elemento != null && primeiro.elemento.getNome().compareTo(ultimo.elemento.getNome()) == 0) {
			ultimo = tmp;
		}
	...
	public Serie removerInicio(Log log) throws Exception {
        Serie resp = null;
	...
	public Serie removerMeio(int posicao) throws Exception {
      Celula i;
      Serie resp = null;
      int cont;
...
public class Q08 {
    ...
    public static void main(String[] args) {
        ...
        HashIndiretoLista tabHash = new HashIndiretoLista();
        ...
        while(isFIM(entrada)==false){
            ...
            tabHash.inserirInicio(serie, log);
        ...
        Arq.openWrite("matricula hashIndireta.txt", "UTF-8");
