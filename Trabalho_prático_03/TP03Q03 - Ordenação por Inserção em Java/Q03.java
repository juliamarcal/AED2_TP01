...
class Lista{
    ...
    //Ordenacao por insercao dos elementos da lista com chave Idioma
    public void ordenar(Log log){
		...
		for (int i = 1; i < n; i++) {
            ...
            while ((j >= 0) && 
            ((array[j].getIdiomaOriginal().compareTo(tmp.getIdiomaOriginal()) > 0)  || 
            ((array[j].getIdiomaOriginal().compareTo(tmp.getIdiomaOriginal())==0)) &&
...
public class Q03{
    ...
    public static void main(String[] args) throws Exception {
        ...
        Arq.openWrite(" matricula insercao.txt", "UTF-8");
